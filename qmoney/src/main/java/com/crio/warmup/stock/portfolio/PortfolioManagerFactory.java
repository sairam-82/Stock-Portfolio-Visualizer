...
public class PortfolioManagerFactory {
  ...
  @Deprecated
  public PortfolioManagerFactory(){

  }
  
  public PortfolioManagerFactory(StockQuotesService stockQuotesService){
  ...
  //       ./gradlew test --tests PortfolioManagerFactory
   ...
   public static PortfolioManager getPortfolioManager(String provider,
     RestTemplate restTemplate) {
          // this.stockQuotesService=StockQuoteServiceFactory.getService(provider,restTemplate);
